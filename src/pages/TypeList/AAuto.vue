         ...
         <div>
              <div class="pro-box" v-for="item in 8" :key="item">
                  ...
                  <div class="pro-jianbox">
                      <div class="pro-name"><img src="/static/img/logo-icon/kuaishou.png" alt="">吃货向阳妞妞</div>
                      <div class="pro-jian">俺有金钟罩铁布衫</div>
                       <div class="pro-jian">
                          <el-tag
                             size="small"                     
                             type="danger"
                ...
                <div class="pro-cont" >
                  <div class="pro-td" style="width:60px;">
                    <span class="pro-title">粉丝数</span>
                    <span>12万</span>
                  </div>
                  ...
                  <div class="pro-td pro-price">
                    <span class="pro-title">报价类型</span>
                    <span >原创视频+发布</span>
                    <span class="pro-title">价格有效期：2019-09-05</span>
                  </div>    
                  <div class="pro-td pro-price"  style="width:90px;">
                  ...
                  <div>
                    ...
                    <div class="heisebox" style="width:250px;">
                  ...
                  <div class="pro-td pro-price" style="width:90px;">
                    <span class="pro-title">播放单价</span>
                    <span >--</span>
                 </div>  

                 <div class="pro-td" style="width:100px;">
                  <span class="pro-title">平均播放量</span>
                  <span>--</span>
                 </div>
                  <div class="pro-td" style="width:100px;">
                   <span class="pro-title">平均互动数</span>
                   <span>点赞：0</span>
                   <span>评论：9万</span>
                   <span>弹幕：0</span>
                </div> 
                <div class="pro-td">
                  <span class="pro-title">SNBT</span>
                  <span Style="color: #fd3400">84.5</span>
                </div>                                                  
                <div class="pro-td" style="width:150px;">
                  <span class="pro-title">受众画像</span>
                  <span >性别：女性居多</span>
                  <span >年龄：19-25/0-18</span>
                  <span >地域：广东/北京...</span>
                  <span >兴趣：美食/游戏...</span>
                </div>                                                                                        
                <div class="pro-td" style="width:80px;">
    ...
    return {
      ...
      screen: {
        ...
        friend: [
          ...
          {name: '2000-5000', value: ''},
          {name: '5000-10000', value: ''},
          {name: '10000-50000', value: ''},
          {name: '50000-100000', value: ''},
          {name: '200000以上', value: ''}
        ], // 好友数量
        price: [
          {name: '不限', value: ''},
          ...
          {name: '2000-5000元', value: ''},
          {name: '5000-10000元', value: ''},
          {name: '10000-20000元', value: ''},
          {name: '20000元以上', value: ''}
        ] // 价格
      }, // 筛选条件
