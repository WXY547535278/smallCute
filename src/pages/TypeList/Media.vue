         ...
         <div>
              <div class="pro-box" v-for="item in 8" :key="item">
                  ...
                  <div class="pro-jianbox">
                      <div class="pro-name"><img src="/static/img/logo-icon/sheying.png" alt="">吃货向阳妞妞</div>
                ...
                <div class="pro-cont">
                  ...
                  <div>
                    <div class="pro-td pro-price" style="width:60px;">
                        <span class="pro-title">参考报价</span>
                        <span style="color: #fd3400">￥ 5000</span>
                     
                    </div>
                    <div class="heisebox" style="width:200px;height:90px;">
                    ...
                    <div class="pro-td" style="width:120px;">
                      <span class="pro-title">平均播放数</span>
                      <span>--</span>
                    </div>
                  ...
                  <div class="pro-td" style="width:200px;">
