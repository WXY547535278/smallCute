         ...
         <div>
              <div class="pro-box" v-for="item in 8" :key="item">
                  ...
                  <div class="pro-jianbox">
                      <div class="pro-name"><img src="/static/img/logo-icon/douyin.png" alt="">吃货向阳妞妞</div>
                ...
                <div class="pro-cont">
                  <div class="pro-td" style="width:70px;">
                  ...
                  <div class="pro-td" style="width:110px;">
                  ...
                  <div class="pro-td" style="width:90px;">
