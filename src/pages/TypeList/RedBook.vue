         ...
         <div>
              <div class="pro-box" v-for="item in 8" :key="item">
                  ...
                  <div class="pro-jianbox">
                      <div class="pro-name"><img src="/static/img/logo-icon/xiaohongshuicon.png" alt="">吃货向阳妞妞</div>
                ...
                <div class="pro-cont">
                  ...
                  <div class="pro-td">
                    <span class="pro-title">平均互动量</span>
                    <span >评论(视频/文章)：-/-</span>
                    <span >转发(视频/文章)：153/-</span>
                    <span >评论(视频/文章)：405/-</span>
                    <span >点赞(视频/文章)：3136/-</span>
                  </div>                    
                  <div class="pro-td">
